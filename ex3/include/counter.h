...
** BCNT_PROC	
********************************************************************************/
#define	BCNT_PROC(max, mr, cp0, cp1, O0, O1, O2, O3, flag)							\
{																				\
		UCHAR ucret;															\
		ucret = BCNT_Evaluate(mr, cp0, cp1, max, &flag);								\
		O0 = (ucret & 0x01);													\
		ucret >>= 1;															\
		O1 = (ucret & 0x01);													\
		ucret >>= 1;															\
...
UCHAR	BCNT_Evaluate( UCHAR mr, UCHAR cp0, UCHAR cp1, UCHAR max, int* flag );
